...
![]({{ site.baseurl }}/assets/images/CTF/Osiris/WrongKeyCmd.PNG)
so we will search for this text in IDA pro we will see this function 
![]({{ site.baseurl }}/assets/images/CTF/Osiris/mainfunction.PNG)
...
![]({{ site.baseurl }}/assets/images/CTF/Osiris/function401100.PNG)
...
print(sentence)
```
![]({{ site.baseurl }}/assets/images/CTF/Osiris/flag.PNG)
